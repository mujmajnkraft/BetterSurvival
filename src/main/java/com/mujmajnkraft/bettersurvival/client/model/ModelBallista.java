...
public class ModelBallista extends ModelBase {
	...
	public ModelBallista() {
		...
		partB.addBox(-22, 0, -2, 44, 2, 1);//main part
		partB.addBox(-22, 0, -1, 36, 1, 2);
		partB.addBox(-22, 0, 1, 44, 2, 1);
		partB.addBox(-22, 0, 2, 4, 5, 1);
		...
		partC.addBox(-10.5F, 0.5F, -0.5F, 20, 1, 1);//bolt
		partC.addBox(9.5F, 0, -1, 1, 2, 2);
		
		partD.addBox(-2.5F, -1, 0, 5, 2, 1);
		partD.addBox(-1, -2.5F, 0, 2, 5, 1);
		partD.addBox(-2.5F, -1, 2, 5, 2, 2);
		partD.addBox(-1, -2.5F, 2, 2, 5, 2);
		partD.setRotationPoint(17.5F, 1.5f, -3);

		partE.addBox(-2.5F, -1, 0, 5, 2, 1);
		partE.addBox(-1, -2.5F, 0, 2, 5, 1);
		partE.addBox(-2.5F, -1, 2, 5, 2, 2);
		partE.addBox(-1, -2.5F, 2, 2, 5, 2);
		partE.addBox(-4.5F, -0.5F, 0, 9, 1, 1);
		partE.addBox(-0.5F, -4.5F, 0, 1, 9, 1);
		partE.setRotationPoint(17.5F, 1.5f, -3);
	...
	public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) 
	{
		...
		EntityBallista ballista = (EntityBallista) entityIn;
		float f = ballista.loadingProgress();
